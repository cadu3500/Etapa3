...
import Jantar from "../Model/Jantar";
import JantarDatabase from "../Database/JantarDatabase";
import {RNCamera} from 'react-native-camera';


export default class CadastroJantar extends Component{
  constructor(props){
    super(props);
    this.state={
      nome: "",
  ...
  Inserir=(nome,calorias,imagem)=>{
    const JantarNovo=new Jantar(nome,calorias,imagem)
    const Banco=new JantarDatabase()
    Banco.Inserir(JantarNovo)
  }
    ...
    return(
      <ScrollView>
        <View style={Estilo.Corpo}>
          <Text style={Estilo.Titulo}>Cadastro do Jantar</Text>
