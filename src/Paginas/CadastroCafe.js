...
export default class CadastroCafe extends Component{
  constructor(props){
    super(props);
    this.state={
      nome: "",
  ...
  Inserir=(nome,calorias,imagem)=>{
    const CafeNovo=new Cafe(nome,calorias,imagem)
    const Banco=new CafeDatabase()
    Banco.Inserir(CafeNovo)
  }
    ...
    return(
      <ScrollView>
        <View style={Estilo.Corpo}>
          <Text style={Estilo.Titulo}>Cadastro do Café da Manhã</Text>
